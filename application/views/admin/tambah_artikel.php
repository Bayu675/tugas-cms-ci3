...
<div class="container" style="max-width: 800px;">
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3">
            <h5 class="mb-0 fw-bold text-primary">Tulis Artikel Baru</h5>
        </div>
        <div class="card-body p-4">
            ...
            <form action="<?= base_url('admin/tambah') ?>" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" name="judul" class="form-control form-control-lg" placeholder="Contoh: Tutorial CodeIgniter" required>
                </div>
                
                <div class="mb-4">
                    <label class="form-label fw-bold">Konten Artikel</label>
                    <textarea name="konten" class="form-control" rows="10" placeholder="Tulis isinya di sini..." required></textarea>
                </div>

                <div class="d-flex justify-content-between">
                    <a href="<?= base_url('admin') ?>" class="btn btn-secondary px-4">Kembali</a>
